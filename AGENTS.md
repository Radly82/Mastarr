...
- `.github/workflows/release.yml` is manually dispatched. It verifies before publishing versioned AMD64/ARM64 images to `ghcr.io/radly82/mastarr`, with SBOM/provenance. A successful build alone is not proof of a published/publicly pullable image.
