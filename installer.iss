...
[Icons]
Name: "{group}\MastARR"; Filename: "{app}\launch.bat"; IconFilename: "{app}\ma1.jpg"; Tasks: startmenu
Name: "{commondesktop}\MastARR"; Filename: "{app}\launch.bat"; IconFilename: "{app}\ma1.jpg"; Tasks: desktopicon
